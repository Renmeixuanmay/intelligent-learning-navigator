...
with st.sidebar:
    ...
    if compare_on:
        compare_type = st.selectbox("选择对比策略", ["无不确定性 MPC", "SimpleEffective", "DQN", "随机策略"], index=0)
    else:
        compare_type = None
